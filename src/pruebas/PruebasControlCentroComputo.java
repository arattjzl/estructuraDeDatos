...
public class PruebasControlCentroComputo {
    public static void main(String[] args) {
        ...
        // UsoComputadora
        UsoComputadora usoComputadora1 = new UsoComputadora(usuario1);
        UsoComputadora usoComputadora2 = new UsoComputadora(usuario2);
        UsoComputadora usoComputadora3 = new UsoComputadora(usuario3);
        UsoComputadora usoComputadora4 = new UsoComputadora(usuario4);
        UsoComputadora usoComputadora5 = new UsoComputadora(usuario5);
        ...
        controlCentroComputo.computadorasQuePuedenCorrerApp(app3).imprimir();
    }
}
